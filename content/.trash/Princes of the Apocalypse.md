...
***Secret Door.*** A secret door is hidden behind the southeasternmost statue. It can be found with a successful DC 15 Wisdom (Perception) check.
...
Two dwarf **guards** stand watch atop this stony shelf. Instead of spears and shields, they carry warhammers that they wield with two hands (1d10 + 1 bludgeoning damage on a hit). Without shields, they have AC 14. Whether or not the guards are present depends on how quietly the charactersapproach:
